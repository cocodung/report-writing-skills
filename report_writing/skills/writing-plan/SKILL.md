...
5. 표시용 소제목·표·그림·다음 절 연결의 소속을 표시한다. 그림에는 [그림 메모 계약](../../references/artifacts.md#figures)에 따라 writing-plan 단계의 전달할 핵심을 적는다. 최종 문단 수나 문장 표현은 고정하지 않는다. 상세도와 소속이 모호하면 [연결 예시](../../references/connected-example.md#expansion)를 확인한다.
